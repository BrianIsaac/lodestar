...
CREATE INDEX IF NOT EXISTS idx_interactions_insight ON interactions(insight_id);
CREATE INDEX IF NOT EXISTS idx_reflections_customer ON reflections(customer_id, created_at DESC);
